      ...
      <>
        <div className='container'>
          <div className="px-4 py-5 my-5 text-center">
            <img className="bg-white rounded shadow d-block mx-auto mb-4" src="https://alitools.io/en/showcase/image?url=https%3A%2F%2Fae01.alicdn.com%2Fkf%2FHTB11h0Lae3tHKVjSZSgq6x4QFXaK%2Fvanzlife-Plastic-squeeze-sauce-bottle-home-ketchup-salad-squeeze-bottle-seasoning-bottle-sauce-honey-jam-juice.jpg" alt='string' width="600"/>
